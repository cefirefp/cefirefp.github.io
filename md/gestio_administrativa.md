...
2. **Entrar en Indemnizaciones/Comisiones** i polsar buscar ![](images/boto_buscar.png) per a que aparega el botó de ![](images/boto_mas.png), que polsarem per a crear una nova comissió de servei.  
...
3. **Omplirem totes les dades necessàries**
    ...
    <ol type="1">
      ...
      <li><strong>HOSTALATGE / RESTAURACIÓ</strong>: es calcula <strong>automàticament</strong> quan polses el botó ![](images/calcular.png), situat baix a la dreta, una vegada introduïdes les dates.</li>
